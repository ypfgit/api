...
public class ShiroMethod {
	 ...
	 * @return
	 */
	public static String[] getUiPermissions(String enName){
		if (getSubject() != null) {
			Dto permission = (Dto) getSubject().getSession()
					.getAttribute(TSConstants.SESSION_AUTHUI);
			String[] permissions = permission.getAsString(enName).split(",");
			return permissions;
        }else
        	return null;
	}
