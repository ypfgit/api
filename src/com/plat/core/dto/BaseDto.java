...
import com.plat.core.util.TypeCaseHelper;
import com.plat.core.util.XmlHelper;
...
public class BaseDto extends HashMap implements Dto, Serializable {
	...
	public String toXml(String pStyle) {
		String strXml = null;
		if (pStyle.equals(TSConstants.XML_Attribute))
			// 节点属性值风格
			strXml = XmlHelper.parseDto2Xml(this, "root", "row");
		else if (pStyle.equals(TSConstants.XML_Node))
			// 节点元素值风格
