package com.plat.core.exception;
...
public class NullAbleException extends RuntimeException {
	...
	public NullAbleException() {
		super(TSConstants.Exception_Head + "对象不能为空,请检查.");
	}
	...
	public NullAbleException(Class cs) {
		super(TSConstants.Exception_Head + "对象不能为空,请检查.[" + cs + "]");
	}
	...
	public NullAbleException(String pNullField) {
		super(TSConstants.Exception_Head + "对象属性[" + pNullField + "]不能为空,请检查.");
